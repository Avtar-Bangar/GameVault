      ...
      <div class="row">
         <div class="col-xs-12 col-md-6">
           <div class="iframe-border">
             <a href="#" data-toggle="modal" data-target="#myModal"><img  src="<?php echo esc_url(get_template_directory_uri());?>/images/video.jpg" alt="..." /><button type="button"></button></a>
           </div>
    ...
    <div class="game-vault home">
      <div class="row">
        <div class="col-xs-12 col-md-7 vault-section">
           ...
           <div class="submit-wrap" ><a class="btn btn-default btn-read-more" href="<?php echo site_url(); ?>/about">Read More</a></div>
